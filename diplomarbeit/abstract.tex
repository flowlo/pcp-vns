...
This is where the aspect of optimizing networks comes to mind. In this work we will show in detail how to model and solve the real world problem of assigning wavelengths to communication lines in fibre networks relying on \emph{Wavelength Division Multiplexing} (WDM) using the \emph{Partition Graph Coloring Problem} (PCP). We will present a solution using metaheuristic approaches, namely a \emph{Variable Neighborhood Search} (VNS).
\end{abstract}
