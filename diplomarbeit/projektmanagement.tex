...
\centering
\begin{tikzpicture}[
  basic/.style  = {draw, text width=6cm, rectangle, font=\sffamily\footnotesize, align=center},
  root/.style   = {basic, rounded corners=2pt, thin, text width=21.9cm},
  part/.style = {basic, rounded corners=6pt, thin, text width=4.5cm},
  work package/.style = {basic, thin, text width=4.5cm, sibling distance=4cm, font=\sffamily\scriptsize},
  >=latex]
...
Abgesehen von der Wahl von onestepCD aufgrund der offensichtlichen Vorteile wurde vor allem die Tabu-Suche von \citet*{Noronha2006} genauer analysiert, um daraus eventuell Schlüsse für leistungsfähige Nachbarschaften ziehen zu können. In der Tat führte dies zur Implementierung der Tabu-Suche als Nachbarschaft zu Testzwecken. %TODO referenz auf onestep, referenz auf tabusearch paper
