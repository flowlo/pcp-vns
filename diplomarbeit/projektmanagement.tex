...
\node [below = 4mm of c3 , draw=Red] (c31) {\footnotesize\ap{3.1}\\ Implementieren von \emph{TabuSearch}};
\node [below = 3mm of c31, draw=Red] (c32) {\footnotesize\ap{3.2}\\ Implementieren von \emph{ChangeColor}};
\node [below = 3mm of c32, draw=Red] (c33) {\footnotesize\ap{3.3}\\ Implementieren von \emph{ChangeNode}};
\node [below = 3mm of c33, draw=Red] (c34) {\footnotesize\ap{3.4}\\ Implementieren von \emph{DSATUR}};
...
group top shift=.6,
group height=.3,
milestone/.append style={fill=orange, draw=black},
milestone left shift=.8,
milestone right shift=.2,
group peaks height=.3]{1}{49}
...
\subsubsection{\ap{2.5} Implementieren einer Visualisierung}
...
\subsubsection{\ap{3.2} Implementieren von ChangeColor}
\begin{center}
\begin{tabular}{lll}
	Mitarbeit & Verantwortlichkeit & Betreuer informiert \\
	\hline
...
\subsubsection{\ap{3.3} Implementieren von ChangeNode} 
...
Da es sich bei \emph{ChangeNode}, erläutert in Abschnitt~\ref{sec:changenode}, um eine kompliziertere Nachbarschaft handelt, wurde sie als eine der letzten implementiert. 

\subsubsection{\ap{3.4} Implementieren von DSATUR}
