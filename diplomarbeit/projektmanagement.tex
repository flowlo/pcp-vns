...
\subsubsection{\ap{3.2} Implementierung von ChangeColor}
\begin{center}
\begin{tabular}{lll}
	Mitarbeit & Verantwortlichkeit & Betreuer informiert \\
	\hline
...
\subsubsection{\ap{3.3} Implementierung von ChangeNode} 
...
Da es sich bei ChangeNode, erläutert in Abschnitt~\ref{sec:changenode}, um eine kompliziertere Nachbarschaft handelt, wurde sie als eine der letzten implementiert. 
