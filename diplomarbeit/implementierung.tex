...
Obwohl \emph{ChangeAll} eine große Ähnlichkeit mit sowohl \emph{ChangeColor} als auch \emph{ChangeNode} aufweist, entstand diese Nachbarschaft erst wesentlich später. Der Ansatz dieser Nachbarschaft ist im Abschnitt~\ref{sec:changeall} zu finden.
