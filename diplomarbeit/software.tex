...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth]{img/ubigraph.png}
\caption[Ein Beispiel der graphischen Ausgabe der Ubigraph-Software]{Ein Beispiel der graphischen Ausgabe der Ubigraph-Software. Auf der linken Seite ist die durch die VNS verbesserte Lösung zu sehen, auf der rechten Seite wurde zum Vergleich die durch die Konstruktionsheuristik berechnete Lösung abgebildet.}
\label{img:ubigraph}
\end{figure}
