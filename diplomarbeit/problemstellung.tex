...
In rein optischen Netzen, als Netzwerken, in denen Information rein über optische Leiter wie Glasfaser übertragen wird, kann \textit{Wavelength Division Multiplexing}
...
Aus diesen Bedingungen kann ein Graph abgeleitet werden, der genau jene Bedürfnisse erfüllt, um eine einfaches lösen des Problems zu ermöglichen. Dern Ausgangsgraph
...
zwischen zwei Kommunikationsendpunkten, gibt es nur einen Knoten in dieser Menge. Diese Menge an Knoten wird Partition genannt, und ist damit namensgebend für das PCP.
...
verwendet wird. Teilen sich Routen 1 und 2 mehr als ein Teilstück, so werden sie trotzdem nur einmal per Kante verbunden.
...
auszuwählen, und die anderen quasi auszublenden. 