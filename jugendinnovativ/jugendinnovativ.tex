...
\begin{center}
\vspace*{\fill}
{\Large P}\ {\large R\ O\ J\ E\ K\ T\ B\ E\ R\ I\ C\ H\ T}
...
{\Large\bfseries Jugend Innovativ Wettbewerb 2013}
...
Ziel ist es, einen neuen Algorithmus zu entwickeln, welcher mit bestehenden Lösungs\-an\-sät\-zen konkurrieren kann. Zu diesem Zwecke wird der Algorithmus in ein konkretes Programm umgesetzt, um ihn auf die in der Literatur verwendeten Probleminstanzen anzuwenden.
...
Videoaufzeichnungen des Ablaufs einer Version des Programms mit Visualisierung finden Sie unter:
